...
const Themes: React.FC = () => {
  ...
  // Get the actual resolved theme for preview
  const getPreviewTheme = (): "light" | "dark" => {
    if (theme === "system") {
  ...
  const handleMouseLeave = (e: React.MouseEvent<HTMLButtonElement>): void => {
    const target = e.currentTarget;
    const isActive =
      (target.textContent?.includes("Light") && theme === "light") ||
      (target.textContent?.includes("Dark") && theme === "dark") ||
      (target.textContent?.includes("System") && theme === "system");
        ...
        >
            ...
            >
              <button
                ...
                style={{
                  ...
                  backgroundColor:
                    theme === "light" ? currentColors.border : "transparent",
                }}
              ...
              <button
                ...
                style={{
                  color: currentColors.text,
                  backgroundColor:
                    theme === "dark" ? currentColors.border : "transparent",
                }}
              ...
              <button
                ...
                style={{
                  color: currentColors.text,
                  backgroundColor:
                    theme === "system" ? currentColors.border : "transparent",
                }}
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              {(
                Object.entries(colorPalettes) as [PaletteKey, ColorPalette][]
              ).map(([key, palette]) => (
                <button
                  key={key}
                  className={`relative w-10 h-10 rounded-full border-2 transition-all duration-200 group cursor-pointer ${
                    colorPalette === key ? "ring-2 ring-offset-2" : ""
                  }`}
                  style={{
