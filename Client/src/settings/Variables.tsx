        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              >
                Configure your application's environment variables securely and
                efficiently
              </p>
            </div>
          </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-end gap-3 pt-6 border-t border-gray-200 dark:border-slate-700">
                      ...
                      >
                        ...
                        <span>{isSaving ? "Saving..." : "Save Variables"}</span>
                      </button>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      >
                        Saved Environment Variables ({savedVariables.length})
                      </h2>
                    </div>
