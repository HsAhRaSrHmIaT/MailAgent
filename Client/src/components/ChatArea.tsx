...
const ChatArea = ({
  ...
  return (
    ...
    >
      {messages?.length !== 0 ? (
        <div className="flex-1 flex flex-col overflow-y-auto" ref={chatAreaRef}>
                ...
                {message.type === "email" ? (
                  ...
                  <div
                    ...
                    style={{
                      ...
                      color:
                        message.sender === "user" ? "#fff" : currentColors.text,
                      boxShadow:
                        "0 1px 4px 0 " +
                        (message.sender === "user"
                          ? currentPalette.primary + "22"
                          : currentColors.border + "22"),
                    }}
                  >
          ...
          <div className="max-w-md space-y-4">
            <div className="mb-6">
              ...
              <p
                ...
                style={{ color: currentColors.textSecondary }}
              >
                Your intelligent companion for conversations and professional
                email drafting
              </p>
            </div>
