      ...
      if (response.success && response.email) {
        ...
        if (emailId) {
          try {
            ...
            console.error("Failed to update regeneration count:", error);
          }
        }
  ...
  return (
    ...
    >
      <p className="select-none text-sm sm:text-base">
        I'll help you create that email. Here's a professional template: SEND To{" "}
        <i className="font-bold">{emailData?.to}</i>{" "}
      </p>
        ...
        <div className="space-y-2">
          {isEditing ? (
            ...
            <div className="whitespace-pre-wrap">
              <div>
                <strong>Subject:</strong> <span>{emailData?.subject}</span>
              </div>
              <div
      ...
      <div className="flex flex-wrap gap-1.5 sm:gap-2 mt-3">
        ...
        >
          {copied ? (
            <GoCheck size={16} className="sm:w-[18px] sm:h-[18px]" />
          ) : (
