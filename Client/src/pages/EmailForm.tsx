...
const EmailForm = () => {
  ...
  const totalSteps =
    ...
    commands[commandState.command as keyof typeof commands]
      ? commands[commandState.command as keyof typeof commands].steps.length
      : 0;
  ...
  return (
    <div className="flex h-screen overflow-hidden">
          ...
          >
            <div className="flex items-end space-x-3">
              ...
              <SendButtons
                ...
                disabled={
                  !message.trim() ||
                  (commandState.isActive && commandState.command === "/clear")
                }
              />
            </div>
      ...
      >
        ...
        <Link to="/settings">
          <IoSettingsOutline size={24} style={{ color: currentColors.text }} />
        </Link>
      </div>
    </div>
  );
